...
FigureS5E <- function(mat,mat_expr,mat_prom_acc,anno_mat,which_clusters=NULL,object=coembed.object,features,cols1,cols2,cluster_cols,anno.size,width,height,out_f){
  pd <- object$pseudotime
...
FigureS5F <- function(mat_f,mat_rna,anno_mat,object=coembed.object,subset_mat=T,features,cols1,cols2,cols3,cluster_cols,anno.size,width,height,out_f){
  mat_rna <- mat_rna[,colnames(mat_f)]
...
FigureS5D(archr_obj=archr_obj,flank=500,motif='Neurog2(var.2)',regions=NULL,
          normalize_by='Subtract',file_f='FigureS5D_1',cols=ATAC_cluster_colors[1:4],
...
FigureS5D(archr_obj=archr_obj,flank=500,motif='Tead2',regions=NULL,
          normalize_by='Subtract',file_f='FigureS5D_2',cols=ATAC_cluster_colors[1:4],
          which_clusters=c('NSC','IPC','PN1','PN2'),plot_bias=T,anno.size=12,key.size=4,width=6,height=6)
FigureS5D(archr_obj=archr_obj,flank=500,motif='Fos..jun.var.2_327',regions=NULL,
          normalize_by='Subtract',file_f='FigureS5D_3',cols=ATAC_cluster_colors[1:4],
          which_clusters=c('NSC','IPC','PN1','PN2'),plot_bias=T,anno.size=12,key.size=4,width=6,height=6)
FigureS5D(archr_obj=archr_obj,flank=500,motif='Ctcf',regions=NULL,
          normalize_by='Subtract',file_f='FigureS5D_4',cols=ATAC_cluster_colors[1:4],
          which_clusters=c('NSC','IPC','PN1','PN2'),plot_bias=T,anno.size=12,key.size=4,width=6,height=6)
#Figure S5E
o <- FigureS5E(mat=p2glinks$posCor,anno_mat=read.table('results/P2G_binaryMat_posCor.tsv',header=T),which_clusters=c("NSC","IPC","PN1","PN2"),
               ...
               object=coembed.object,out_f='FigureS5E',
...
o_m <- FigureS5F(anno_mat=read.table('results/P2G_binaryMat_posCor.tsv',header=T),
                 ...
                 object=coembed.object,subset_mat=T,out_f='FigureS5F',
